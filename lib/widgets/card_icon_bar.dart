...
class CardIconBar extends StatefulWidget {
  ...
  const CardIconBar(this.name, this.player, {super.key});

  @override
  CardIconBarState createState() => CardIconBarState();
}

class CardIconBarState extends State<CardIconBar> {
  @override
  Widget build(BuildContext context) {
    final Size size = MediaQuery.of(context).size;

    String rsTextToShare =
        'Yàlla mooy ' +
    ...
    audioShare() async {
      ...
      Uint8List arbyte = (await rootBundle.load(
        'assets/audio/arnames/${widget.name.id}.mp3',
      )).buffer.asUint8List();
      Uint8List wobyte = (await rootBundle.load(
        'assets/audio/wonames/${widget.name.id}.mp3',
      )).buffer.asUint8List();
      Uint8List versebyte = (await rootBundle.load(
        'assets/audio/verses/${widget.name.id}.mp3',
      )).buffer.asUint8List();
